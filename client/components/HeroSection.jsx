...
export function HeroSection() {
  ...
  const buttonVariants = {
    hover: {
      scale: 1.05,
      boxShadow: "0 0 20px rgba(255, 146, 17, 0.5)",
        ...
        >
          ...
          >
            <motion.span
              custom={0}
              variants={textVariants}
              className="bg-gradient-to-r from-[#ff9211] to-[#e0820f] bg-clip-text text-transparent"
            >
              Code.
            </motion.span>{" "}
          ...
          >
            <span className="font-semibold text-[#ff9211]">
              Rewarding Open Source Excellence
            </span>{" "}
            on Core Blockchain!
          </motion.p>
          <motion.p
          ...
          >
            Stake tokens, contribute to GitHub, and earn rewards. Our AI ranks
            the top 5 developers monthly, sharing staked yields.
          </motion.p>
            ...
            >
              ...
              <motion.circle
                ...
                animate={{
                  ...
                  filter: [
                    "drop-shadow(0 0 2px rgba(255, 146, 17, 0.2))",
                    "drop-shadow(0 0 8px rgba(255, 146, 17, 0.6))",
                  ],
                }}
                transition={{
                  duration: 15,
              ...
              <motion.circle
                ...
                animate={{
                  ...
                  opacity: [0.4, 0.6, 0.4],
                  filter: [
                    "drop-shadow(0 0 1px rgba(0, 255, 170, 0.3))",
                    "drop-shadow(0 0 5px rgba(0, 255, 170, 0.7))",
                  ],
                }}
                transition={{
                  duration: 4,
              ...
              {[0, 45, 90, 135, 180, 225, 270, 315].map((angle, index) => (
                <motion.circle
                  ...
                  animate={{
                    ...
                    opacity: [0.7, 1, 0.7],
                    filter: [
                      "drop-shadow(0 0 0px #ff9211)",
                      "drop-shadow(0 0 3px #ff9211)",
                    ],
                  }}
                  transition={{
                    duration: 3,
              ...
              {[0, 1, 2, 3].map((index) => (
                <motion.circle
                  ...
                  animate={{
                    cx: [
                      100 + 92 * Math.cos((index * 90 * Math.PI) / 180),
                      100,
                    ],
                    cy: [
                      100 + 92 * Math.sin((index * 90 * Math.PI) / 180),
                      100,
                    ],
                    opacity: [0, 1, 0],
                  }}
                  ...
                  [0, 1, 2, 3, 4].map((col) => (
                    <motion.rect
                      ...
                      animate={{
                        opacity: [
                          0.2,
                          row === col ? 0.9 : Math.random() > 0.6 ? 0.7 : 0.2,
                          0.2,
                        ],
                        fill:
                          row === col
              ...
              <motion.circle
                ...
                animate={{
                  scale: [1, 1.1, 1],
                  filter: [
                    "drop-shadow(0 0 2px rgba(255, 146, 17, 0.7))",
                    "drop-shadow(0 0 8px rgba(255, 146, 17, 0.9))",
                  ],
                }}
                transition={{
                  duration: 2,
